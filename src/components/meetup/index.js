...
const Meetup = () => {
  const { id } = useParams();
  const [meetsup, setMetsup] = useState("");
      ...
      <Wrap>
        ...
        <WrapItem>
            ...
            >
              ...
              <Text fontSize="6xl">{meetsup.titel}</Text>
              <Text fontSize="4xl">{meetsup.desc}</Text>
              <Image
                boxSize="100px"
                objectFit="cover"
                src="{Post.img}"
